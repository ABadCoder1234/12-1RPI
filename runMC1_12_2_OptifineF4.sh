#!/bin/sh
# Advanced Settings
# Login Information (This is secure)
# Fill in with actual information (Unlike what you see here)
MINECRAFT_LOGIN=prominecraftgamer@mlg.noscope.trickshot.com
MINECRAFT_USERNAME=XxpewdiepieLoverxX
MINECRAFT_PASSWORD=BabyYodaIsDope
